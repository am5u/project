...
if(!isset($_FILES['image']['tmp_name']))
{
	...
	if($picture == "")
	{
		...
		if($imageFileType != "jpg" && $imageFileType != "png" && $imageFileType != "jpeg") {
			...
			$query = "INSERT INTO  info_student(id_school,teacher_number,firstname,lastname,phone,picture,Quiz,Assigment,Course,Attendence,final_mark,class) VALUES 
     ('$id_school','$teacher_id','$firstname','".$lastname."','$phone','$picture'
     ,'$Quiz','$Assigment','$Course','$Attendence','$final_mark','$grading')";
