...
<div class="container">
    ...
    <form action="../savecard.php" method="post">
        ...
        <div class="inputBox">
            <span>card holder</span>
            <input  name="card-holder-input" type="text" class="card-holder-input">
        </div>
        <div class="flexbox">
            <div class="inputBox">
                <span>expiration mm</span>
                <select name="month-input" id="" class="month-input">
            ...
            <div class="inputBox">
                ...
                <select name="year-input" id="" class="year-input">
            ...
            <div class="inputBox">
                <span>cvv</span>
                <input name="cvv-input" type="text" maxlength="4" class="cvv-input">
            </div>
        </div>
        <input name="submit" type="submit" value="submit" class="submit-btn">
    </form>
