	...
	if($picture == "")
	{
		echo "<script>alert('من فضلك اختر صورة')</script>";
			...
			(name,email,password,image)
			 VALUES ('$name','$email','$pass','$picture')";
				mysqli_query($conn,$query);
				$query = "INSERT INTO users
				(name,email,password,image,usertype)
				VALUES ('$name','$email','$pass','$picture','$usertype')";
								mysqli_query($conn,$query);
...
<div class="col-lg-8">
<strong style="text-align:center"> اضافة طالب</strong>
      <div class="container">
	  <form action="" method="post" enctype="multipart/form-data">


            <div class="form-group col-lg-12 col-sm-8">
               <label for="Author" class="col-sm-2 control-label">الاسم </label>
               <div class="col-sm-10">
            ...
            <div class="form-group col-lg-12 col-sm-8">
               <label for="Publisher" class="col-sm-2 control-label">الايميل </label>
               <div class="col-sm-10">
