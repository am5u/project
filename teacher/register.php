...
if(isset($_POST['submit'])){
   ...
   if($select_tutor->rowCount() > 0){
      ...
      if($pass != $cpass){
         ...
         $insert_tutor->execute([ ,$name, $profession, $email, $cpass, $image]);
         $update_user = $conn->prepare("UPDATE `users` SET usertype = ? WHERE email = ?");

         $update_user->execute(['tutor', $email]);
   ...
   <form class="register" action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         ...
         <div class="col">
            ...
            <input type="password" name="cpass" placeholder="confirm your password" maxlength="" required class="box">
